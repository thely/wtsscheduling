...
function pods_cf_init () {
	...
	add_filter( 'caldera_forms_render_get_field_slug-centers', 'pods_cf_preload_options');
	add_filter( 'caldera_forms_render_get_field_slug-departments_covered', 'pods_cf_preload_options');
