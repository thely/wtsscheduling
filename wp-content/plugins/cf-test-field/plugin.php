...
add_filter('caldera_forms_get_field_types', 'test_field_register_function');
 ...
 * @return array $fields
 */
function test_field_register_function($fields){
	...
	$fields['cf-test-field'] = array(
		"field"				=>	__("My Custom Field Type", 'cf-test-field'),
		"file"				=>	plugin_dir_path( __FILE__ ) . 'field.php',
		"category"			=>	"Basic,Pickers", 									// comma separated list of categories to place the field in
		"description" 		=>	__('This is a custom field for my needs','cf-test-field'), 	// description explains what the field is for
