<?php
/**
 * Plugin Name: Caldera Forms - URL Parameter Field
 * Author:      Chris Hunt
 * License:     GPL-2.0+
...
add_filter('caldera_forms_get_field_types', 'url_param_field_register_function');
 ...
 * @return array $fields
 */
function url_param_field_register_function($fields){
	...
	$fields['url_param_field'] = array(
		"field"				=>	"URL Param Field",
		"file"				=>	plugin_dir_path( __FILE__ ) . 'field.php',
		"category"			=>	"Basic", 									// comma separated list of categories to place the field in
		"description" 		=>	'Field for retrieving URL Param in form', 	// description explains what the field is for
