...
$key_file_location = 'My Project-c73e71398c4f.p12'; //key.p12
...
$event->setSummary("New event wow!!!1");
$start = new Google_Service_Calendar_EventDateTime();
$start->setDate("2014-10-20");
$end = new Google_Service_Calendar_EventDateTime();
$end->setDate("2014-10-21");
$event->setStart($start);
$event->setEnd($end);

$newEvent = $service->events->insert('$calendar_id', $event);
echo $newEvent->getId();
*/

// -------------------- FOR UPDATING EVENTS
/*$event_id = "jqe16mko0ims6lff39kq8om6eg";
$event = $service->events->get($calendar_id, $event_id);
$event->setDescription("reserved by a student");
